...
> 이번 프로젝트를 통해 웹 개발에 대한 전반적인 지식(프론트엔드, 백엔드, HTTP 등)과 Git, Github, Linux에 대한 숙련도를 상승시킬 수 있었으며, 코딩을 할 때 어려운 부분을 해결하거나 특정 파트에 집중하는 것에 있어서 협업의 중요성을 느낄 수 있었습니다. 이를 바탕으로 다음 프로젝트는 더 많은 인원들로 팀을 구성하여 현재 프로젝트에서의 아쉬웠던 점을 해결함과 동시에 더 큰 규모의 프로젝트를 진행해 보고자 하는 마음이 들었습니다.
